...
namespace GaussianSplatting.Runtime
{
    ...
    public class GaussianSplatRenderer : MonoBehaviour
    {
        ...
        [Min(1.0f)]
        [Tooltip("Maximum screen-space radius used when decomposing splat covariance")]
        public float m_MaxSplatScreenSize = 4096.0f;
        ...
        internal static class Props
        {
            ...
            public static readonly int MaxSplatScreenSize = Shader.PropertyToID("_MaxSplatScreenSize");
        ...
        internal void CalcViewData(CommandBuffer cmb, Camera cam)
        {
            ...
            cmb.SetComputeFloatParam(m_CSSplatUtilities, Props.MaxSplatScreenSize, m_MaxSplatScreenSize);
